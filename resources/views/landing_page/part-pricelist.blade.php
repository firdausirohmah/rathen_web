...
<style>
  ...
  * {
  ...
  .count {
    ...
    border: none;
    color: blue;
    /* Sesuaikan dengan warna teks yang diinginkan */
    text-decoration: underline;
    /* Menambahkan garis bawah untuk menunjukkan bahwa itu adalah tautan */
    cursor: pointer;
    padding: 0;
    font-size: inherit;
  }
...
<section id="home" style="overflow: hidden;">
  ...
  <div class="container-xxl visually-hidden">
            ...
            <div class="container">
              ...
              <div class="row view-on-sm">
                <style>
                  ...
                  .text-smt {
                    flex: 1;
                    /* Membuat teks memanfaatkan ruang yang tersedia */
                    padding: 20px;
    ...
    <div id="data1Content" class="button-content">
      <h2>Konten Tombol 1</h2>
      <p>Ini adalah konten untuk Tombol 1.</p>
    </div>

    <div id="data2Content" class="button-content">
  ...
  <style>
    ...
    .img-fluid {
      ...
      /* Efek transisi pada transformasi */
    }
              ...
              <div id="content1" class="card-text content">
                <div class="container-fluid">
                  <div class="row center mt-5">
                    @for($i = 1; $i <= 10; $i++) @php $imageKey="g" . $i; @endphp @if($data->$imageKey)
