...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-6">
            <img src="/asset/images/top.jpg" alt="Your Image" style="width: 50%; height: 100%;">
        </div>
    </div>
</div>
<br>
<div class="container">
    <div class="row">
        <div class="col-lg-12" style="font-family: 'Mont Heavy', sans-serif; font-weight: bold;text-align: center; position: center;">
            <p class="store-name" style="text-align: center; align-items: center;
            justify-content: center;
            text-align: center;">RATHEN STORE </p>
