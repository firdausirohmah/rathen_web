    ...
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
          <h2 class="mb-4 display-5 text-center" style="font-family: Montheavy; color: #1890fd; font-size: 24px; font-weight: bold; margin-bottom: 20px; ">PROSEDUR PEMESANAN</h2>
      ...
      <div class="row mb-4 gy-5">
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="text-center px-xl-2">
            ...
            <p class="m-0 text-secondary">
                ...
                < p> <strong>1. FANS VERSION (Minimun order 12 pcs) - </strong> Kualitas Standar </ p><br>
                < p> <strong>2. STADIUM  VERSION (Minimun order 12 pcs) -  </strong> Kualitas Medium </ p> <br>
                < p> <strong>3. PRO VERSION (Minimun order 24 pcs) -  </strong> Kualitas PRO</ p>
            </p>
                    </div>
        </div>
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="text-center px-xl-2">
            ...
            <P class="m-0 text-secondary">Sejak pembayaran DP 50% kami terimaApabila selesai lebih cepat, kami akan informasikan kepada Anda.</P>
                    </div>
                  </div>
                  <div class="col-12 col-sm-6 col-lg-4">
                    <div class="text-center px-xl-2">
                      ...
                      <p class="m-0 text-secondary">Pesanan jersey kamu akan selesai 2-3 hari kerja sejak pembayaran pelunasan kami terima.                    </p>
                      <p class="m-0 text-secondary">Bagi yang mau melakukan pengambilan jersey <strong>  self-pickup</strong>, bisa langsung datang ke offline store kami.  </p>
                      <p class="m-0 text-secondary">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <div class=" px-xl-2">
                          ...
                          <p class="m-0 text-secondary align-left"> Segala bentuk kesalahan produksi yang disebabkan oleh tim produksi, akan kami perbaiki sebagai bentuk komitmen kami untuk selalu memberikan pelayanan yang terbaik untuk customer. </p>
                          <br><p class="m-0 text-secondary">Hal ini tidak berlaku apabila kelalaian atau kerusakan disebabkan oleh customer.</p>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="text-center px-xl-2">
                              ...
                              <br><p class="m-0 text-secondary">Dapatkan berbagai merchandise unik sebagai refferal benefits.</p>
