      ...
      <div class="payment">
        <div class="payment__info" style="width:129rem">
                ...
                <table class="table table-bordered mt-4 mb-0 table-extra">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Kerah Kancing</td>
                      <td class="text-center">{{ $jqty }}</td>
                      <td><span id="hargaBbm">Rp <?= number_format($price->kerah_kancing, 0, ','); ?>
                      </td>
                      <td id="totalBbm">Rp <?= number_format($total, 0, ','); ?>
                    </tr>
                    @endif
          ...
          <div class="container w-unset">
            ...
            <div class="mb-4 ml-2">
              <a href="/production/edit-invoice/{{$kode}}" target="_blank" class="btn">Edit Data
            ...
            <div>
              <a href="{{ route('export', ['kode'=> $kode]) }}" class="btn action__submit">Download
