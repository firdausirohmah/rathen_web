...
document.querySelector('input[name="2xl"]').addEventListener('input', function() {
    var quantity = parseInt(this.value) || 0;
    additionalCost = quantity * 20000; // Update additional cost based on input value
    updateTotalHarga();
});

document.querySelector('input[name="3xl"]').addEventListener('input', function() {
    var quantity = parseInt(this.value) || 0;
    additionalCost = quantity * 35000; // Update additional cost based on input value
    updateTotalHarga();
});

document.querySelector('input[name="4xl"]').addEventListener('input', function() {
    var quantity = parseInt(this.value) || 0;
